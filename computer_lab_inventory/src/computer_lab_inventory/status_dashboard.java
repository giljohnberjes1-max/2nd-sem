 ...
 * @author Gildork
 */
public class status_dashboard extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(status_dashboard.class.getName());

    /**
     * Creates new form add_dashboard
     */
    public status_dashboard() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new status_dashboard().setVisible(true));
    }
